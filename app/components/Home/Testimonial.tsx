...
<TestimonialCard customerReviewData={customerReviewData}/>
  ...
  <div className="relative flex w-2/3 h-2/3 items-center justify-center pl-28">
    ...
    <img src="https://i.ibb.co/DfPMSvzs/potato.png" alt="Tomato" className="absolute -bottom-1/2 left-1/3 w-1/2 rotate-180 object-cover" />
    
    <div className="absolute h-[350px] w-[350px] rounded-full border-2 border-dashed border-primary/50"></div>
