...
import { popularProductData, popularRestuarentData } from '@/app/assets/data';
        ...
        popularRestuarentData && popularRestuarentData.map((restaurent, index)=>(
            <SwiperSlide key={index} className=''>
                <div className="">
                            ...
                            <Image src={restaurent?.img} fill className='!object-cover !max-h-[175px] rounded-t-2xl' alt='product img'/>
                             </div>
                            ...
                            <div className="flex items-center justify-center gap-2 text-white pl-1 pr-3 py-2 bg-primary rounded-r-full">
                             ...
                             </div>                                           <div className=" absolute bottom-3 right-5 bg-white flex items-center justify-center py-1 px-3 border gap-1 border-gray/50 rounded-full">
